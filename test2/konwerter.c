...
{
  int  IloscKodow = 10;
  int  Rozmiar = IloscKodow * sizeof(4*'�'); /*dla jezyka c funkcja sizeof zwroci rozmiar typu int, a w jezyku c++ rozmiar typu char, wiec aby jezyk c++ dzialal nalezy pomnozyc rozmiar razy 4,
  aby sizeof zwrocil odpowiednia wartosc*/
